...
# Also upload RDS version -- OPTIONAL! RDS use less memory, better for extremely large files
...
# Or refer to by name
sst_plots[["Jefferson Head - surface"]]
```
...
Is there a common name for bottom temp like there is for sst? Huh. 

NEED TO DECIDE which logger we want to use for bottom temp. Make time to poke around and see what is the most reliable. Perhaps Sophie has an idea about this already?

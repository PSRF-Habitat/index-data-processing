...
site_pos_combos <- con |> distinct(site, position)
...
con_plots <- pmap(site_pos_combos, function(site, position) {
  plot_sensor_issues(con, site, position,
                     sensor_col   = "high_range_microsiemens_per_cm",
                     y_label      = "Conductivity (µS/cm)",
                     title_sensor = "Conductivity")
})

# Name the list for easy reference
names(con_plots) <- paste(site_pos_combos$site, site_pos_combos$position, sep = " - ")
